...
const Card = ( {id, title, imgUrl, price, onClickPlus, onClickFavorite, goodsInCart} ) => {
    ...
    return (
        <div className="border rounded-2xl w-56 p-6 flex flex-col gap-4 relative hover:shadow-xl transition ease-in-out duration-200 transform hover:-translate-y-1">
            <button className="absolute border-0  focus:outline-none transition ease-in-out duration-200 transform hover:scale-125" onClick={onClickFavoriteButton}>
                <img src={isFavorited ? '/img/heart-active.svg' : '/img/heart.svg'} alt="Heart"/>
            </button>
            ...
            <div className="flex justify-between items-center">
                ...
                <button className="border-0 focus:outline-none transition ease-in-out duration-200 transform hover:scale-125"
